    ...
    <>
      ...
      <div className="banner-2">
        <img
          ...
          // src={homedata.imgbanner2.img_src_banner}
          alt="First slide"
      ...
      <Container className="mt-5">
        <div>
          ...
          <Row className=" d-flex justify-content-center">
            <Col lg={5} md={5} className="mt-5">
              <p className="news_paras">
                Writing Essays help in developing the mental ability of a kid
                and contributes to his overall development. Encourage young
                minds to write short and simple 10 Lines Essays from an early
                age.
              </p>
              <p className="news_paras">
                <spna>
                ...
                &nbsp; Writing Essays help in developing the mental ability of a
                kid and contributes to his overall development.
              </p>
            </Col>
            <Col lg={6} md={6}>
              <hr
          ...
          <p className="news_paras mt-5">
            Writing Essays help in developing the mental ability of a kid and
            contributes to his overall development. Encourage young minds to
            write short and simple 10 Lines Essays from an early age write short
            and simple 10 Lines Essays.
          </p>
        </div>
      </Container>
      {/* <Container fluid>
