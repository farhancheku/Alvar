        ...
        <Container fluid style={{ background: backcolor, color: textcolor}}>
          <Row>
            ...
            <Col lg={6} md={6} sm={12} className="container-column">
              <Row>
                ...
                >
                  <h5 className="headings-123" style={{marginLeft: "10px"}}>Industries</h5>

                  <ul
                    className="footerStyle"
                    style={{ lineHeight: "1.4",marginLeft: "10px"}}
                  >
                    <li>
                      {" "}
                      <Link
                ...
                <Col
                  ...
                  style={{ borderLeft: `3px solid ${textcolor}` }}
                >
                  <h2 className="headings-123" style={{marginLeft: "10px"}}>Contact us</h2>
                  <ul className="footerStyle" style={{marginLeft: "10px"}}>
                    <li>
                      <a
                        href="/enquiry"
                        className="list-footer"
                ...
                <Col
                  ...
                  style={{ borderLeft: `3px solid ${textcolor}` }}
                >
                  <h2 className="headings-123" style={{marginLeft: "10px"}}>About Us</h2>
                  <ul className="footerStyle" style={{marginLeft: "10px"}}>
                    ...
                    <li>
                      {envlink ? (
                        <Link to={envlink} style={{ color: textcolor }}>
                          Env. Impact
                        </Link>
                      ) : (
                        <Link
          ...
          <div className="footer-text mt-3">
            <div style={{ color: textcolor }}>
              <p className="footer-text-p" style={{ marginLeft: "30px" }}>
                info@alvar.is
              </p>
              <p>+354 5508300</p>
            </div>
