...
const MistCoreSlider2 = ({ comment0, comment1, comment2, imagesprops }) => {
  return (
    <>
      <div className="my-5">
        <div
        ...
        >
          ...
          <div className="row pt-5 g-0 flex-row-reverse">
            <div className="col-12 col-lg-6 col-sm-12">
              <div className="fw-bold mistcoreslider2-text m-2">
                {" "}
                <h3>
...
export default MistCoreSlider2;
