const data = {
  ...
  videoSrc: "https://player.vimeo.com/video/727061173",

  banner: {
    img_src: "./images/n__bn.png",
    img_src_logo: "/images/Group6230.png",
    text_1: "PROTECT",
    text_2: "PRODUCT",
    text_3: "&PEOPLE",
    text_4: "Combat bacteria and fight costs in the Meat Industry",
  ...
  Bussinesprot: {
    ...
    text_1:
      "ALVAR reduces production and reputational risks, increases food safety tremendously and reduces waste of water and chemicals.ALVAR Mist Core can disinfect a 3.500 square meter Meat factory in 30 minutes, saving 90% of water, 50 to 70% of chemicals and 100% of labour costs during the disinfection process while increasing the product shelf life by 1-2 days with the corresponding reduction of food-waste.",
  },
  Resourcepreserve: {
  ...
  Simpleswiper: {
    img_src_g1: "/images/meatt1.png",
    img_src_g2: "/images/meatt.png",
    img_src_6: "/images/meatt.png",

    img_src_1: "./images/Royal2.png",
    img_src_2: "./images/Royal1.png",
    img_src_3: "./images/Eurobeef.png",
  ...
  howmist: {
    text_1:
      "Visit our media section to see how ALVAR Mist penetrates and reaches the most difficult areas in a meat production line.",
